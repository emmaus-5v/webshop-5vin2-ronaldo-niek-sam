...
insert into products (name, description, recommended_minimum_age_id, rating_id, studio_id, code, price) values ('Tinytanic', 'In the year 6969 the tinytanic goes on an expedition to find the long lost bar of soap. It travels trough the bathtub looking for the legendary soap. Untill… a giant rubber ducky appears which they crash into. The tinytanic sinks to the bottom of the bathtub and trough the drain never to be found again',
 5, 6, 2, '077030122-3', 11);
insert into products (name, description, recommended_minimum_age_id, rating_id, studio_id, code, price) values ('Soy Story 3', 'The foods live happily together in the kitchen when there is no one home. Until one day the soybeans get bored and go on an adventure. They explore the house looking for new dips and seasonings until the bend-o-matic 3000 appears. Can the soybeans escape or will they be turned into soy sauce.',
 1, 7, 3, '445924201-X', 13.5);
insert into products (name, description, recommended_minimum_age_id, rating_id, studio_id, code, price) values ('Black Pfanzer', 'A thousand years ago 5 armies fought war over a meteorite which contained vibranium. One army build a tank out if it first and that became the first black pfanzer. The king Tank’Chaka visits his brother because he things he’s selling vibranium on the black market. Can the black pfanzer prevent vibranium from going all around the world or will there soon be more black pfanzers?',
 3, 8, 5, '686928463-6', 14);
insert into products (name, description, recommended_minimum_age_id, rating_id, studio_id, code, price) values ('The Goatfather', 'Don vito goatleone is the head of a American goat family. On the day his daughter gets milked he cant reject any offers from her due to old traditions. Other animals come to Don with requests because they think they are mistreated. Don almost dies in the slaughterhouse when he is about to be turned into goat steak when he somehow manages to escape. He will take revenge and he does so by pooping all over the slaughterhouse.',
...
insert into products (name, description, recommended_minimum_age_id, rating_id, studio_id, code, price) values ('Mad Max: Fury Toad', 'After the apocalypse the toads’ lives mainly consist of finding food and water. One day the leader sends frogiosa on a mission to collect lots of water. But when he sees frogiosa takes a different route than they agreed to he finds out that is 5 toadetes are missing as well. The leader sends max to capture them but he escapes and joins frogiosa. Together they run far away from the other toads looking for a new place.',
